        ...
        <div className="flex flex-col gap-4 border-b border-zinc-200 pb-5 md:flex-row md:items-start md:justify-between">
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-500">
                Same timer, same locked question set for both players.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 md:min-w-[240px]">
            <div className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-3">
              ...
              <p className="mt-2 text-sm font-medium capitalize text-zinc-950">
        ...
        {countdownSeconds > 0 ? (
          <div className="flex min-h-[320px] flex-col items-center justify-center gap-4 text-center">
            ...
            <p className="max-w-md text-sm text-zinc-500">
              Battle is locked in. Both players start at the same moment.
            </p>
          </div>
          ...
          <div className="flex min-h-[320px] flex-col items-center justify-center gap-4 text-center">
            ...
            <div>
              ...
              <p className="mt-2 max-w-md text-sm text-zinc-500">
                Your answers are saved. The server is waiting for the other player or timer expiry.
              </p>
            </div>
          </div>
        ) : (
            ...
            <div className="space-y-3">
              {currentQuestion.answerOptions.map((option, index) => (
                <Button
                  ...
                  variant="outline"
                  className="h-auto w-full justify-start whitespace-normal rounded-xl px-4 py-4 text-left text-sm leading-6 text-zinc-700 hover:bg-zinc-100"
      ...
      <div className="space-y-4">
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-zinc-950">Match progress</h2>
              <p className="text-sm text-zinc-500">Updated from the server while the battle is running.</p>
            </div>
          </div>
          ...
          <div className="mt-4 space-y-3">
            <div className="rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3">
              ...
              <p className="mt-1 text-xs capitalize text-zinc-500">{matchState.self.status.replace('_', ' ')}</p>
            </div>
            ...
            <div className="rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3">
              ...
              <p className="mt-1 text-xs capitalize text-zinc-500">{matchState.opponent.status.replace('_', ' ')}</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-zinc-950">Rules</h2>
              <p className="text-sm text-zinc-500">Fast summary for the live round.</p>
            </div>
          </div>

          <ul className="mt-4 space-y-2 text-sm leading-6 text-zinc-600">
            <li>One question at a time.</li>
            <li>No answer reveal during the match.</li>
            <li>Draws are based on equal correct answers only.</li>
          </ul>
        </div>
      </div>
    </div>
